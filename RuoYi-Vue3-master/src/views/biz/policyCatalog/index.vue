<template>
  <div class="app-container" style="background:#f6f8fb;min-height:calc(100vh-84px);padding:20px">
    <div class="catalog-hero animate-fade-in-up">
      <h1 class="hero-title">政策超市</h1>
      <p class="hero-desc">浏览全部惠企政策 · 一键查看匹配条件 · 智能精准推荐</p>
    ...
    <div class="catalog-toolbar animate-fade-in-up stagger-2">
      <div class="toolbar-left">
        <div class="search-box">
          <el-input v-model="filterName" placeholder="搜索政策名称..." clearable size="large" prefix-icon="Search" @input="applyFilter" />
        </div>
        <el-select v-model="filterType" clearable placeholder="政策类型" size="large" @change="applyFilter">
          <el-option label="补贴" value="1" />
          <el-option label="奖励" value="2" />
          <el-option label="减免" value="3" />
        </el-select>
        <el-select v-model="filterStatus" clearable placeholder="状态" size="large" @change="applyFilter">
    ...
    <el-dialog v-model="detailVisible" :title="detailData?.policyName" width="560px" class="detail-dialog" destroy-on-close>
    ...
    <el-dialog v-model="applyVisible" title="申请政策" width="520px" destroy-on-close append-to-body>
    ...
    <el-dialog title="政策文件预览" v-model="pdfPreviewVisible" width="1100px" append-to-body>
