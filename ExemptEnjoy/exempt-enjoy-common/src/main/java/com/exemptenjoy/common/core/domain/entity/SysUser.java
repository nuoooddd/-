package com.exemptenjoy.common.core.domain.entity;
...
import com.exemptenjoy.common.xss.Xss;
...
public class SysUser extends BaseEntity
{
    ...
    public String getFaceVerified()
    {
        return faceVerified;
    }

    public void setFaceVerified(String faceVerified)
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("phoneVerified", getPhoneVerified())
            .append("idCardVerified", getIdCardVerified())
            .append("faceVerified", getFaceVerified())
